...
export const Footer = () => (
  <div className="flex flex-col justify-between gap-16 bg-black px-8 py-16 text-white lg:flex-row lg:px-[4vw] lg:py-24">
    <div className="flex w-full max-w-3xl flex-col gap-16">
      <div className="flex flex-col gap-8">
        ...
        <form action="https://gumroad.com/follow_from_embed_form" method="post" className="flex gap-1">
          ...
          <button type="submit" className="rounded bg-pink px-4 py-2 text-black">
            →
          </button>
        </form>
      </div>
      <div className="flex items-center gap-2">
        <img className="h-6 w-6" src={PinkIcon} alt="" loading="lazy" />
        <div>Ⓒ Gumroad, Inc.</div>
      </div>
    </div>
    <div className="flex w-full max-w-3xl flex-col gap-16">
      ...
      <div className="flex justify-between">
        <a href="https://twitter.com/gumroad" className="hover:text-pink">
        ...
        <a href="https://www.youtube.com/channel/UC6o7H5wr2Cf4ibntYEs4Mcg" className="hover:text-pink">
