...
class PaypalChargeProcessor
  ...
  DEFAULT_PAYPAL_ORDER_DESCRIPTION = "Gumroad purchase"
  private_constant :DEFAULT_PAYPAL_ORDER_DESCRIPTION

  PAYPAL_API_CAPTURE_NOT_COMPLETE = "NotComplete"
  private_constant :PAYPAL_API_CAPTURE_NOT_COMPLETE
