...
describe ProductReviewResponsesController do
  describe "PUT update" do
    ...
    it_behaves_like "authorize called for action", :put, :update do
      ...
      let(:request_params) { { purchase_id: purchase.external_id, message: "Response" } }
    ...
    it "creates a new response if there is none" do
      ...
      put :update, params: { purchase_id: purchase.external_id, message: "New" }, as: :json
    ...
    it "allows responding to reviews that do not count towards review stats" do
      ...
      put :update, params: { purchase_id: purchase.external_id, message: "Review response" }, as: :json
    ...
    it "returns an error if the message is blank" do
      put :update, params: { purchase_id: purchase.external_id, message: "" }, as: :json
    ...
    it "404s for non-existent purchase" do
      expect do
        put :update, params: { purchase_id: "non_existent_id", message: "Updated" }, as: :json
